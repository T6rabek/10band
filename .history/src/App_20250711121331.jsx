...
const WritingChecker = () => {
  ...
  const handleCheckWriting = async () => {
    ...
    const prompt = `
      ...
      For each point, first explain the issue, then give a clear example of how to fix it.
...
const IELTSTips = () => (
  <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl">
    ...
    <div className="space-y-8">
      ...
      >
        <p>
          In the Writing test, aim to spend 20 minutes on Task 1 and 40 minutes
          on Task 2. Task 2 is worth more marks. Don't get stuck on one section
          for too long!
        </p>
      </TipCard>
      <TipCard
      ...
      >
        <p>
          In your introduction, don't copy the question word-for-word. Show the
          examiner your vocabulary by paraphrasing the prompt using synonyms and
          different sentence structures.
        </p>
      </TipCard>
      <TipCard
        title="Use a Range of Cohesive Devices"
        icon={<CheckCircle className="text-purple-500" />}
      >
        <p>
          Connect your ideas smoothly using words and phrases like
          "Furthermore," "In contrast," "As a result," and "For instance." This
          improves your Coherence and Cohesion score.
        </p>
      </TipCard>
      <TipCard
        title="Address All Parts of the Task"
        icon={<Target className="text-red-500" />}
      >
        <p>
          Read the question carefully. If it asks for "advantages and
          disadvantages," you must discuss both. If it asks for your opinion,
          make it clear throughout the essay.
        </p>
      </TipCard>
    </div>
  </div>
